...
ႁဝ်းၸႂ်ႉၶေႃႈၵႂၢမ်း `struct` သေ ၸိုဝ်ႈမၼ်းလူဝ်ႇတႄႇလူၺ်ႈ **တူဝ်လိၵ်ႈလူင် (Uppercase)** သေႇသေႇၶႃႈ။
...
*   ၼႆႉပွင်ႇဝႃႈ သင်ႁဝ်းလႅၵ်ႈလၢႆႈတူဝ်မႂ်ႇ၊ တူဝ်ၵဝ်ႇမၼ်းတေဢမ်ႇလႅၵ်ႈလၢႆႈၸွမ်းၶႃႈ။
...
> **"တွၼ်ႈတႃႇ ၸၢႆးမၢဝ်း ႁဵတ်း Keyboard ၼၼ်ႉ: ၸၢႆးမၢဝ်းထုၵ်ႇလီၸႂ်ႉ Struct တွၼ်ႈတႃႇမၵ်းမၼ်ႈ 'Key' ၵူႈတူဝ်။ မိူၼ်ၼင်ႇ `struct ShanKey` ဢၼ်မီး `mainChar`, `subChars`, ลႄႈ `position`။ ၵွပ်ႈ Keyboard ၼိုင်ႈဢၼ်မီး Key ၼမ်တႄႉတႄႉ၊ ၵၢၼ်ၸႂ်ႉ Struct တေႁဵတ်းႁႂ်ႈ Keyboard ၸၢႆးမၢဝ်း ႁဵတ်းၵၢၼ်ၽႂ်းၽၢႆ (Performant) တႄႉတႄႉၶႃႈယဝ်ႉ။"**
